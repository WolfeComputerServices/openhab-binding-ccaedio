 ...
 */
@NonNullByDefault
public class ChannelHandlerUpcomingEvents extends ChannelHandler {
    private static final String CHANNEL_NAME = CCAEdioBindingConstants.CHANNEL_UPCOMING;

    public ChannelHandlerUpcomingEvents(ICCAThingHandler thingHandler, EdioAPIBridge edioBridge, Gson gson) {
